...
object "a:String reference" as A
object "b:String reference" as B
object "c:String reference" as C
object "pooled String object" as PooledString {
  value = "spring"
}
object "heap String object" as HeapString {
  value = "spring"
}

A --> PooledString : refers to
B --> PooledString : refers to
C --> HeapString : refers to

note bottom of PooledString
String literals có thể share pooled object.
end note

note bottom of HeapString
new String(...) tạo object khác dù content giống nhau.
end note
@enduml
```
