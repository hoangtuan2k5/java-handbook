...
- Tune từ GC log/metrics/symptom thật, không từ flag “best practice” chung.
- Đổi từng flag một và đo lại; thay nhiều flag cùng lúc làm mất khả năng học.
- Tăng heap không phải fix; có thể giảm tần suất mà tăng cost mỗi collection.
- Phân biệt heap pressure với retention problem; nguyên nhân khác nhau, fix khác nhau.
- Average pause đẹp không phủ nhận tail pause xấu; theo dõi p99/p999.
